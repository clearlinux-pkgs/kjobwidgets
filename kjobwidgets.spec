...
Source0  : https://download.kde.org/stable/frameworks/5.49/kjobwidgets-5.49.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.49/kjobwidgets-5.49.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1535430353
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5JobWidgets.so.5.49.0
