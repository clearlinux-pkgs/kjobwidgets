...
Source0  : https://download.kde.org/stable/frameworks/5.98/kjobwidgets-5.98.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.98/kjobwidgets-5.98.0.tar.xz.sig
...
%prep
%setup -q -n kjobwidgets-5.98.0
cd %{_builddir}/kjobwidgets-5.98.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662944785
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5JobWidgets.so.5.98.0
