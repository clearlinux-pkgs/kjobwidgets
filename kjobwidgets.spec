...
Source0  : https://download.kde.org/stable/frameworks/5.48/kjobwidgets-5.48.0.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1532037133
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5JobWidgets.so.5.48.0
