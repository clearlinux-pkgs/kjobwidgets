...
Source0  : https://download.kde.org/stable/frameworks/5.99/kjobwidgets-5.99.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.99/kjobwidgets-5.99.0.tar.xz.sig
...
%prep
%setup -q -n kjobwidgets-5.99.0
cd %{_builddir}/kjobwidgets-5.99.0
...
/usr/lib64/libKF5JobWidgets.so.5.99.0
